...
const ejercicio65 = (n1, n2) => {
    if (n1 % n2 === 0)
        console.log(n1 + " es múltiplo de " + n2);
    else
        console.log(n1 + " no es múltiplo de " + n2);
};
// 66: Múltiplo mejorado (A de B o B de A)
const ejercicio66 = (n1, n2) => {
    if (n1 % n2 === 0)
        console.log(n1 + " es múltiplo de " + n2);
    else if (n2 % n1 === 0)
